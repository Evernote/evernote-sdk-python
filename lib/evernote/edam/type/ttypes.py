...
class UserAttributes:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.salesforcePushEnabled)
    value = (value * 31) ^ hash(self.shouldLogClientEvent)
    return value
...
class Note:
  ...
  thrift_spec = (
    ...
    (18, TType.STRUCT, 'limits', (NoteLimits, NoteLimits.thrift_spec), None, ), # 18
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.limits)
    return value
...
class NotebookRestrictions:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.noRenameNotebook)
    return value
