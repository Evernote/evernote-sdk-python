...
class BackupPaymentInfo(object):
  """
...
class PremiumInfo(object):
  ...
  def __init__(self, currentTime=None, premium=None, premiumRecurring=None, premiumExpirationDate=None, premiumExtendable=None, premiumPending=None, premiumCancellationPending=None, canPurchaseUploadAllowance=None, premiumUpgradable=None,):
...
class User(object):
  ...
  def __init__(self, id=None, username=None, email=None, name=None, timezone=None, privilege=None, serviceLevel=None, created=None, updated=None, deleted=None, active=None, shardId=None, attributes=None, accounting=None, businessUserInfo=None, photoUrl=None, photoLastUpdated=None, accountLimits=None, subscriptionInfo=None,):
    self.id = id
