...
class NoteFilter:
  ...
  thrift_spec = (
    ...
    (10, TType.STRING, 'context', None, None, ), # 10
  )
...
class NoteResultSpec:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.includeSharedNotes)
    value = (value * 31) ^ hash(self.includeNoteAppDataValues)
    value = (value * 31) ^ hash(self.includeResourceAppDataValues)
    value = (value * 31) ^ hash(self.includeAccountLimits)
    return value
