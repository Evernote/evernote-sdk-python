...
class PublicUserInfo:
  ...
  def __init__(self, userId=None, shardId=None, privilege=None, serviceLevel=None, username=None, noteStoreUrl=None, webApiUrlPrefix=None,):
    self.userId = userId
...
class UserUrls:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.noteStoreUrl)
    value = (value * 31) ^ hash(self.webApiUrlPrefix)
    value = (value * 31) ^ hash(self.userStoreUrl)
    value = (value * 31) ^ hash(self.utilityUrl)
    value = (value * 31) ^ hash(self.messageStoreUrl)
    value = (value * 31) ^ hash(self.userWebSocketUrl)
    return value
...
class AuthenticationResult:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.publicUserInfo)
    value = (value * 31) ^ hash(self.noteStoreUrl)
    value = (value * 31) ^ hash(self.webApiUrlPrefix)
    value = (value * 31) ^ hash(self.secondFactorRequired)
    value = (value * 31) ^ hash(self.secondFactorDeliveryHint)
    value = (value * 31) ^ hash(self.urls)
    return value
...
class BootstrapSettings:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.serviceHost)
    value = (value * 31) ^ hash(self.marketingUrl)
    value = (value * 31) ^ hash(self.supportUrl)
    value = (value * 31) ^ hash(self.accountEmailDomain)
    value = (value * 31) ^ hash(self.cardscanUrl)
    value = (value * 31) ^ hash(self.announcementsUrl)
    value = (value * 31) ^ hash(self.enableFacebookSharing)
    value = (value * 31) ^ hash(self.enableGiftSubscriptions)
    value = (value * 31) ^ hash(self.enableSupportTickets)
    value = (value * 31) ^ hash(self.enableSharedNotebooks)
    value = (value * 31) ^ hash(self.enableSingleNoteSharing)
    value = (value * 31) ^ hash(self.enableSponsoredAccounts)
    value = (value * 31) ^ hash(self.enableTwitterSharing)
    value = (value * 31) ^ hash(self.enableLinkedInSharing)
    value = (value * 31) ^ hash(self.enablePublicNotebooks)
    value = (value * 31) ^ hash(self.enableGoogle)
    return value
